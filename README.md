...
The [four-model testing report](benchmarks/results/2026-09-13/README.md) records 208 initial generation attempts, 60 post-fix regressions, 120 throughput samples, 18 registered row proofs, three complete-operation packages and 3,000 proof mutations, with CPU/memory measurements and preserved failures. Reproduction commands and the expanded CI coverage are documented in [benchmarks/README.md](benchmarks/README.md).
